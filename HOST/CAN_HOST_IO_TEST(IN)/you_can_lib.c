...
void LoadCanBuffer(unsigned int i)
{
    ...
    switch(i){
        ...
        case    2:
            ...
            CAN_Buf[6]= sRamDArry[mUnKnown07];
            CAN_Buf[7]= sRamDArry[mUnKnown08];
            break;
        case    3:            
            CAN_Buf[0]= sRamDArry[mUnKnown11];
            CAN_Buf[1]= sRamDArry[mUnKnown12];
            CAN_Buf[2]= sRamDArry[mUnKnown13];
            CAN_Buf[3]= sRamDArry[mUnKnown14];     
            CAN_Buf[4]= sRamDArry[mUnKnown15];
            CAN_Buf[5]=(sRamDArry[mMostLongDst]    +j);
            CAN_Buf[6]= sRamDArry[mStartFloor];
            CAN_Buf[7]=(cF_TOPFLR       +j);
            break;
        case    4:            
            CAN_Buf[0]= sRamDArry[mUnKnown21];
            CAN_Buf[1]= sRamDArry[mUnKnown22];
            CAN_Buf[2]= sRamDArry[mExtIN0];
            CAN_Buf[3]= sRamDArry[mUnKnown24];     
            CAN_Buf[4]= sRamDArry[mUnKnown25];
