...
#define     RUN_MODE                IO_INVERTER 
////////////////////////////////////////////

#define     SET_ELEV_SPEED_PER_MIM      60
#define     SET_ENCODER_PULSE           8192    //600   //office
#define     SET_MOTOR_RPM               96    //600
...
#define     SPEED_60_DEC_LENGTH     970                 //1500     //970                 //1200        //mm
#define     SPEED_90_DEC_LENGTH     1700                //1800        //mm    
#define     SPEED_105_DEC_LENGTH    1700                //2150  //2100        //mm
#define     SPEED_120_DEC_LENGTH    2600                //mm
...
#define  F_OpWtTm               66                      //1
#define  F_OpTtTm               67                      //1

#define  F_UserLamp             68                      //1     17
#define  F_FixFloor             69                      //1
#define  F_FixFloorTime         70                      //1
#define  F_FireSafeFlr          71                      //1

#define  F_SubDoorFlr1          72                      //1     18
#define  F_SubDoorFlr2          73                      //1
#define  F_SubDoorFlr3          74                      //1
#define  F_ErrStopCnt           75                      //1 

#define  F_NextFlrTime          76                      //1     19
#define  F_LuLdOffTime          77                      //1
#define  F_NcNoBit0             78                      //1
#define  F_NcNoBit1             79                      //1

#define  F_NcNoBit2             80                      //1     20
#define  F_NcNoBit3             81                      //1
#define  F_X7SafeFlr            82                      //1
#define  F_FanTime              83                      //1

#define  F_NonService0          84                      //1     21    
#define  F_NonService1          85                      //1     
#define  F_NonService2          86                      //1     
#define  F_NonService3          87                      //1   

#define  F_ElevSpeed            88                      //1     22
#define  F_StartFloor           89                      //1  
#define  F_SerialNm0            90                      //1(2)
#define  F_SerialNm1            91                      //1(2)

#define  F_Passward0            92                      //1     23
#define  F_Passward1            93                      //1
#define  F_Passward2            94                      //1
#define  F_Passward3            95                      //1

#define  F_Ver0                 96                      //1     24
#define  F_Ver1                 97                      //1
#define  F_Ver2                 98                      //1
#define  F_LgtTime              99                      //1

#define  F_BrkStTm11            100                     //1(2)  25
#define  F_BrkStTm10            101                     //1(2)
#define  F_BrkStTm21            102                     //1(2)  
#define  F_BrkStTm20            103                     //1(3)

#define  F_BrkStTm31            104                     //1(2)  26
#define  F_BrkStTm30            105                     //1(2)
#define  F_BrkStTm41            106                     //1(2)  
#define  F_BrkStTm40            107                     //1(3)

#define  F_BrkStTm51            108                     //1(2)  27
#define  F_BrkStTm50            109                     //1(2)
#define  F_BrkStTm61            110                     //1(2)  
#define  F_BrkStTm60            111                     //1(2)

#define  F_StTm1                112                     //1     28
#define  F_StTm2                113                     //1
#define  F_StTm3                114                     //1  
#define  F_StTm4                115                     //1

#define  F_Su1Sd1_Velocity      116                     //1     29
#define  F_Su2Sd2_Velocity      117                     //1     
#define  F_Su3Sd3_Velocity      118                     //1     
#define  F_FhmOnOff             119                     //1

#define  F_DoorJumperOff        120                     //1     30
#define  F_x0                   121                     //1     
#define  F_x1                   122                     //1     
#define  F_x2                   123                     //1     

#define  F_x3                   124                     //1     31
#define  F_x4                   125                     //1     
#define  F_x5                   126                     //1     
#define  F_x6                   127                     //1     
...
#define  BASE_ADDR              0
#define  O_eVer                 BASE_ADDR               //0
#define  O_eTopFlr              3 //O_eVer+3                  //3
#define  O_ePrkFlr              4 //O_eTopFlr+1               // 4
#define  O_eOpWtTm              5 //O_ePrkFlr+1               // 5
#define  O_eOpTtTm              6 //O_eOpWtTm+1               // 6
#define  O_eUserLamp            7 //O_eOpTtTm+1               // 7
#define  O_eFixFloor            8 //O_eUserLamp+1             // 8
#define  O_eFixFloorTime        9 //O_eFixFloor+1             // 9 
#define  O_eNonService0         10 //O_eFixFloorTime+1         // 10      
#define  O_eNonService1         11 //O_eFixFloorTime+1         // 10      
#define  O_eNonService2         12 //O_eFixFloorTime+1         // 10      
#define  O_eNonService3         13 //O_eFixFloorTime+1         // 10      
#define  O_eFlrDspCh            14 //O_eNonService+4           // 14
#define  O_eSysErCnt            78 //O_eFlrDspCh+64            // 78
#define  O_ePassward            162 //O_eSysErCnt+ERR_SAVE_SIZE  // 128
#define  O_eMvCounter           166  //O_ePassward+4             // 132
#define  O_eSerialNm            168 //O_eMvCounter+2            // 134
#define  O_eFireSafeFlr         170 //O_eSerialNm+2             // 134
#define  O_eSubDoorFlr1         171 //O_eFireSafeFlr+1          // 136
#define  O_eSubDoorFlr2         172 //O_eSubDoorFlr1+1          // 136
#define  O_eSubDoorFlr3         173 //O_eSubDoorFlr2+1          // 136
#define  O_eErrStopCnt          174 //O_eSubDoorFlr3+1          // 136
#define  O_eErrCntPt            175 //O_eErrStopCnt+1        // 136
#define  O_eNextFlrTime         176 //O_eErrCntPt+1          // 136
#define  O_eLuLdOffTime         177 //O_eNextFlrTime+1          // 136  Delete
#define  O_eNcNoBit             178 //O_eLuLdOffTime+1          // 136
#define  O_eEnd                 179 //O_eNcNoBit+1        // 137
...
//#define  OUT_DAC1               GET_BITFIELD(&O_U_W_bit).bit7   
...
#define  cF_LGTTIME             GET_LONGFIELD(&FlashDspCharBuf[F_LgtTime/4])        .byte[F_LgtTime%4]
...
//#define  cF_FLRDATARD(adr)      GET_LONGFIELD(&FlashDspCharBuf[adr/4]).byte[adr%4]

#define  b_LdTmpBufRam(adr)     GET_LONGFIELD(&parameter_mirror[(adr%64)/4]).byte[adr%4]

/*
#define  bset_SETUP_RAM(adr,bitn)  (GET_LONGFIELD(&parameter_mirror[adr/4]).byte[adr%4] | bitn)   
#define  bclr_SETUP_RAM(adr,bitn)  (GET_LONGFIELD(&parameter_mirror[adr/4]).byte[adr%4] & bitn) 
*/

//#define  I_SETUP_FLA(adr)       GET_LONGFIELD(&FlashDspCharBuf[adr/4]).intger[(adr%4)/2]
