...
#define	FLOOR_ANOUNCE	1	
//#define   BASE_FL			FLOOR_21
#define   START_FL			FLOOR_U7
...
#define         FLOOR_U7                8  /*27c040*/ //100819,,,B7?? ????? 6->8? ???? ??.    //8
#define         FLOOR_U7                8  /*27c040*/ //100819,,,B7?? ????? 6->8? ???? ??.    //8
#define         FLOOR_U6                FLOOR_U7+1      //9
#define         FLOOR_U5                FLOOR_U7+2	//10
#define         FLOOR_U4                FLOOR_U7+3	//11
#define         FLOOR_U3                FLOOR_U7+4	//12
#define         FLOOR_U2                FLOOR_U7+5	//13
#define         FLOOR_U1                FLOOR_U7+6	//14
#define         FLOOR_1                 FLOOR_U7+7	//15
#define         FLOOR_2                 FLOOR_U7+8	//16
#define         FLOOR_3                 FLOOR_U7+9	//17
#define         FLOOR_4                 FLOOR_U7+10	//18
#define         FLOOR_5                 FLOOR_U7+11	//19
#define         FLOOR_6                 FLOOR_U7+12	//20
#define         FLOOR_7                 FLOOR_U7+13	//21
#define         FLOOR_8                 FLOOR_U7+14	//22
#define         FLOOR_9                 FLOOR_U7+15	//23
#define         FLOOR_10                FLOOR_U7+16	//24
#define         FLOOR_11                FLOOR_U7+17	//25
#define         FLOOR_12                FLOOR_U7+18	//26
#define         FLOOR_13                FLOOR_U7+19	//27
#define         FLOOR_14                FLOOR_U7+20	//28
#define         FLOOR_15                FLOOR_U7+21	//29
#define         FLOOR_16                FLOOR_U7+22	//30
#define         FLOOR_17                FLOOR_U7+23	//31
#define         FLOOR_18                FLOOR_U7+24	//32
#define         FLOOR_19                FLOOR_U7+25	//33
#define         FLOOR_20                FLOOR_U7+26	//34
#define         FLOOR_21                FLOOR_U7+27	//35
#define         FLOOR_22                FLOOR_U7+28	//36
#define         FLOOR_23                FLOOR_U7+29	//37
#define         FLOOR_24                FLOOR_U7+30	//38
#define         FLOOR_25                FLOOR_U7+31	//39
#define         FLOOR_26                FLOOR_U7+32	//40
#define         FLOOR_27                FLOOR_U7+33	//41
#define         FLOOR_28                FLOOR_U7+34	//42
#define         FLOOR_29                FLOOR_U7+35	//43
#define         FLOOR_30                FLOOR_U7+36	//44
#define         FLOOR_31                FLOOR_U7+37	//45
#define         FLOOR_32                FLOOR_U7+38	//46

#define         FLOOR_G                 FLOOR_U7+39     //47
#define         FLOOR_M                 FLOOR_U7+40	//48
#define         FLOOR_L                 FLOOR_U7+41	//49
#define         FLOOR_PH                FLOOR_U7+42	//50
#define         FLOOR_NO                FLOOR_U7+43	//51

#define         FLOOR_B7          		FLOOR_U7+44	//52
#define         FLOOR_B6          		FLOOR_U7+45	//53
#define         FLOOR_B5          		FLOOR_U7+46	//54
#define         FLOOR_B4          		FLOOR_U7+47	//55
#define         FLOOR_B3          		FLOOR_U7+48	//56
#define         FLOOR_B2          		FLOOR_U7+49     //57
#define         FLOOR_B1          		FLOOR_U7+50	//58
#define         FLOOR_F1          		FLOOR_U7+51	//59
#define         FLOOR_F2          		FLOOR_U7+52	//60
#define         FLOOR_F3          		FLOOR_U7+53	//61
#define         FLOOR_F4          		FLOOR_U7+54	//62
#define         FLOOR_F5          		FLOOR_U7+55	//63
#define         FLOOR_F6          		FLOOR_U7+56	//64
#define         FLOOR_F7          		FLOOR_U7+57	//65
#define         FLOOR_F8          		FLOOR_U7+58	//66
#define         FLOOR_F9          		FLOOR_U7+59	//67
#define         FLOOR_F10         		FLOOR_U7+60	//68
#define         FLOOR_F11          		FLOOR_U7+61	//69
#define         FLOOR_F12          		FLOOR_U7+62	//70
#define         FLOOR_F13          		FLOOR_U7+63	//71
#define         FLOOR_F14          		FLOOR_U7+64	//72
#define         FLOOR_F15          		FLOOR_U7+65	//73
#define         FLOOR_F16          		FLOOR_U7+66	//74
#define         FLOOR_F17          		FLOOR_U7+67	//75
#define         FLOOR_F18          		FLOOR_U7+68	//76
#define         FLOOR_F19          		FLOOR_U7+69	//77
#define         FLOOR_F20         		FLOOR_U7+70	//78
#define         FLOOR_F21          		FLOOR_U7+71	//79
#define         FLOOR_F22          		FLOOR_U7+72	//80
#define         FLOOR_F23          		FLOOR_U7+73	//81
#define         FLOOR_F24          		FLOOR_U7+74	//82
#define         FLOOR_F25          		FLOOR_U7+75	//83
#define         FLOOR_F26          		FLOOR_U7+76	//84
#define         FLOOR_F27          		FLOOR_U7+77     //85
#define         FLOOR_F28          		FLOOR_U7+78     //86
#define         FLOOR_F29          		FLOOR_U7+79     //87
#define         FLOOR_F30          		FLOOR_U7+80     //88
#define         FLOOR_F31          		FLOOR_U7+81     //89
#define         FLOOR_F32          		FLOOR_U7+82     //90

#define         FLOOR_PARKING      		FLOOR_U7+83     //91
#define         OPEN_VOICE      		FLOOR_U7+84	//92
#define         CANCLE_VOICE      		FLOOR_U7+85	//93
#define         PUSH_VOICE      		FLOOR_U7+86	//94
#define         FLOOR_S            		FLOOR_U7+87     //95

#define   		TEST_MODE     RD4     //in
#define   		DISABLED      RD5     //in
...
//   RxStatus=STX_CHK;
   ...
   RunPgm=0x55;
    ...
    #ifdef  PCI_GOGLE
           if( (CurVoice >= START_FL) && (CurVoice < FLOOR_9)){
    #else
           if((CurVoice >= START_FL) && (CurVoice <= END_FL)){
    #endif
                 //SelVoice=1;	//100909 - ?????? ??? ??? ?? ?????? ??? ?????.
